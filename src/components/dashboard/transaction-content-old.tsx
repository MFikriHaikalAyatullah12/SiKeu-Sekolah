  ...
  const handleSubmit = async (printReceipt: boolean = false) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // If print receipt button clicked
        if (printReceipt && data.transaction?.id) {
          try {
            ...
            if (receiptResponse.ok) {
              ...
              a.href = url;
              a.download = `${activeTab === "INCOME" ? "kwitansi" : "bukti"}-${data.transaction.id}.pdf`;
              document.body.appendChild(a);
              a.click();
              window.URL.revokeObjectURL(url);
              document.body.removeChild(a);
              toast.success("Bukti berhasil dibuat dan diunduh");
            }
          } catch (error) {
            console.error("Failed to generate receipt:", error);
            toast.error("Gagal membuat bukti");
          }
        }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="fromTo" className="text-sm font-medium">
                    {activeTab === "INCOME" ? "Dari/Penerima" : "Penerima/Vendor"}
                  </Label>
                  <Input
                    id="fromTo"
                    value={formData.fromTo}
                    onChange={(e) => setFormData({ ...formData, fromTo: e.target.value })}
                    placeholder={activeTab === "INCOME" ? "Nama Siswa atau Donatur" : "Nama Vendor atau Penerima"}
                  />
                </div>
                ...
                {/* Bank Account / Source of Funds - Show when Bank Transfer is selected */}
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mb-1">Seret & lepas file nota di sini</p>
                ...
                <div className="space-y-2">
                  <Label htmlFor="notes" className="text-sm font-medium">
                    Catatan <span className="text-gray-400">(optional)</span>
                  </Label>
                  <Textarea
                    id="notes"
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        {activeTab === "INCOME" ? "Simpan Pemasukan" : "Simpan Pengeluaran"}
                      </>
                    )}
                  </Button>
                  <Button
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <Input
                      placeholder={activeTab === "INCOME" ? "Cari siswa/kategori..." : "Cari vendor/kategori..."}
                      value={searchQuery}
                  ...
                  <Select value={sortBy} onValueChange={setSortBy}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="amount-desc">Tertinggi</SelectItem>
                      <SelectItem value="amount-asc">Terendah</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                    ...
                    <TableHeader>
                      <TableRow className="bg-gray-50">
                        ...
                        <TableHead className="font-semibold text-xs">
                          {activeTab === "INCOME" ? "Dari" : "Vendor"}
                        </TableHead>
                        <TableHead className="font-semibold text-xs">Nominal</TableHead>
                        <TableHead className="font-semibold text-xs">Metode</TableHead>
                ...
                {sortedTransactions.length > 0 && (
                  <div className="flex items-center justify-center gap-2 pt-2">
                    <p className="text-xs text-gray-500">
                      Menampilkan 1-5 dari {sortedTransactions.length} transaksi
                    </p>
                  </div>
                )}
